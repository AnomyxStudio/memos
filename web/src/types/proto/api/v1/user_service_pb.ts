...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
   ...
   *
   * @generated from field: string theme_light = 5;
   */
  themeLight: string;
   ...
   *
   * @generated from field: string theme_dark = 6;
   */
  themeDark: string;
};
